  ...
  const training = await replicateAI.trainings.create(
    ...
    "6f1e7ae9f285cfae6e12f8c18618418cfefe24b07172a17ff10a64fb23a6b772",
    {
      ...
      input: {
        ...
        autocaption_prefix:
          "SMA, Inspired from the comic strip, Lichtenstein's pop art painting is composed of evenly spaced Ben-Day dots and unbroken areas of flat color divided by black lines of varying thickness.",
